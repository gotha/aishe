...
# Go client examples
test-basic-client:
	@echo "Testing basic Go client..."
	cd clients/go/basic/example && AISHE_API_URL=http://localhost:8000 go run main.go

test-redis-client:
	@echo "Testing Redis cache Go client..."
	cd clients/go/redis_cache/example && AISHE_API_URL=http://localhost:8000 REDIS_ADDR=localhost:6379 go run main.go
