...
async function main(): Promise<void> {
    ...
    console.log("=== AIshe Question Answering (Session 2: Redis Caching) ===");
    ...
    while (true) {
        ...
        // TODO: check if the question is cached in Redis
        //       - if found (cache HIT), mark source as Redis
        //       - otherwise, mark source as AIshe API
        const retrievalSource: string = (await client.isCached(question)) ? "Redis" : "AIshe API";
